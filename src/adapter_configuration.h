...
class AdapterConfiguration final {
 public:
  ...
  bool is_lso_v2_ipv4_enabled() const {
    if (os_info_.major_version() == 10 && os_info_.sub_version() >= 20348) {
      // TODO (b/250710233): Remove.
      // This fixes a bug in WS22 by disabling TSO.
      return false;
    }
    return lso_v2_ipv4_.value == 1;
  }
  bool is_lso_v2_ipv6_enabled() const {
    if (os_info_.major_version() == 10 && os_info_.sub_version() >= 20348) {
      // TODO (b/250710233): Remove.
      // This fixes a bug in WS22 by disabling TSO.
      return false;
    }
    return lso_v2_ipv6_.value == 1;
  }
  ...
  OsInformation& os_information() { return os_info_; }
